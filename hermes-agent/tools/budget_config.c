...
{
    "distutils": {
        "name": "tools.budget_config",
        "sources": [
            "tools/budget_config.py"
        ]
    },
    "module_name": "tools.budget_config"
}
END: Cython Metadata */
...
#define __PYX_HAVE__tools__budget_config
#define __PYX_HAVE_API__tools__budget_config
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "tools.budget_config" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "tools.budget_config"
extern int __pyx_module_is_main_tools__budget_config;
int __pyx_module_is_main_tools__budget_config = 0;

/* Implementation of "tools.budget_config" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Configurable_budget_constants_fo[] = "Configurable budget constants for tool result persistence.\n\nOverridable at the RL environment level via HermesAgentEnvConfig fields.\nPer-tool resolution: pinned > config overrides > registry > default.\n";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_5tools_13budget_config_12BudgetConfig_resolve_threshold(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_tool_name); /* proto */
...
#define __pyx_kp_u_Immutable_budget_constants_for_t __pyx_string_tab[2]
...
#define __pyx_kp_u_int_float __pyx_string_tab[6]
#define __pyx_kp_u_tools_budget_config_py __pyx_string_tab[7]
#define __pyx_n_u_BudgetConfig __pyx_string_tab[8]
#define __pyx_n_u_BudgetConfig_resolve_threshold __pyx_string_tab[9]
#define __pyx_n_u_DEFAULT_BUDGET __pyx_string_tab[10]
#define __pyx_n_u_DEFAULT_PREVIEW_SIZE_CHARS __pyx_string_tab[11]
#define __pyx_n_u_DEFAULT_RESULT_SIZE_CHARS __pyx_string_tab[12]
#define __pyx_n_u_DEFAULT_TURN_BUDGET_CHARS __pyx_string_tab[13]
#define __pyx_n_u_Dict __pyx_string_tab[14]
#define __pyx_n_u_PINNED_THRESHOLDS __pyx_string_tab[15]
...
#define __pyx_n_u_default_factory __pyx_string_tab[23]
#define __pyx_n_u_default_result_size __pyx_string_tab[24]
#define __pyx_n_u_doc __pyx_string_tab[25]
#define __pyx_n_u_field __pyx_string_tab[26]
#define __pyx_n_u_frozen __pyx_string_tab[27]
#define __pyx_n_u_func __pyx_string_tab[28]
#define __pyx_n_u_get_max_result_size __pyx_string_tab[29]
...
#define __pyx_n_u_preview_size __pyx_string_tab[40]
#define __pyx_n_u_qualname __pyx_string_tab[41]
#define __pyx_n_u_read_file __pyx_string_tab[42]
#define __pyx_n_u_registry __pyx_string_tab[43]
#define __pyx_n_u_resolve_threshold __pyx_string_tab[44]
...
#define __pyx_n_u_tool_name __pyx_string_tab[51]
#define __pyx_n_u_tool_overrides __pyx_string_tab[52]
#define __pyx_n_u_tools_budget_config __pyx_string_tab[53]
#define __pyx_n_u_tools_registry __pyx_string_tab[54]
#define __pyx_n_u_turn_budget __pyx_string_tab[55]
#define __pyx_n_u_typing __pyx_string_tab[56]
#define __pyx_n_u_values __pyx_string_tab[57]
#define __pyx_kp_b_iso88591_81_S_AQ_S_A_4_aq_1_x_1Kxt1 __pyx_string_tab[58]
#define __pyx_int_1500 __pyx_number_tab[0]
#define __pyx_int_100000 __pyx_number_tab[1]
#define __pyx_int_200000 __pyx_number_tab[2]
...
/* Python wrapper */
static PyObject *__pyx_pw_5tools_13budget_config_12BudgetConfig_1resolve_threshold(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_5tools_13budget_config_12BudgetConfig_resolve_threshold, "Resolve the persistence threshold for a tool.\n\n        Priority: pinned -> tool_overrides -> registry per-tool -> default.\n        ");
static PyMethodDef __pyx_mdef_5tools_13budget_config_12BudgetConfig_1resolve_threshold = {"resolve_threshold", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5tools_13budget_config_12BudgetConfig_1resolve_threshold, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_5tools_13budget_config_12BudgetConfig_resolve_threshold};
static PyObject *__pyx_pw_5tools_13budget_config_12BudgetConfig_1resolve_threshold(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("resolve_threshold (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "resolve_threshold", 0) < (0)) __PYX_ERR(0, 38, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("resolve_threshold", 1, 2, 2, i); __PYX_ERR(0, 38, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("resolve_threshold", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 38, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("tools.budget_config.BudgetConfig.resolve_threshold", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_tool_name), (&PyUnicode_Type), 0, "tool_name", 2))) __PYX_ERR(0, 38, __pyx_L1_error)
  __pyx_r = __pyx_pf_5tools_13budget_config_12BudgetConfig_resolve_threshold(__pyx_self, __pyx_v_self, __pyx_v_tool_name);
...
static PyObject *__pyx_pf_5tools_13budget_config_12BudgetConfig_resolve_threshold(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_tool_name) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("resolve_threshold", 0);

  /* "tools/budget_config.py":43
 *         Priority: pinned -> tool_overrides -> registry per-tool -> default.
 *         """
...
*/
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_PINNED_THRESHOLDS); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = (__Pyx_PySequence_ContainsTF(__pyx_v_tool_name, __pyx_t_1, Py_EQ)); if (unlikely((__pyx_t_2 < 0))) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (__pyx_t_2) {

    /* "tools/budget_config.py":44
 *         """
 *         if tool_name in PINNED_THRESHOLDS:
 *             return PINNED_THRESHOLDS[tool_name]             # <<<<<<<<<<<<<<
 *         if tool_name in self.tool_overrides:
...
*/
    ...
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_PINNED_THRESHOLDS); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_Dict_GetItem(__pyx_t_1, __pyx_v_tool_name); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
...
*/
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_self, __pyx_mstate_global->__pyx_n_u_tool_overrides); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = (__Pyx_PySequence_ContainsTF(__pyx_v_tool_name, __pyx_t_3, Py_EQ)); if (unlikely((__pyx_t_2 < 0))) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (__pyx_t_2) {

    /* "tools/budget_config.py":46
 *             return PINNED_THRESHOLDS[tool_name]
 *         if tool_name in self.tool_overrides:
 *             return self.tool_overrides[tool_name]             # <<<<<<<<<<<<<<
 *         from tools.registry import registry
...
*/
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_self, __pyx_mstate_global->__pyx_n_u_tool_overrides); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_1 = __Pyx_PyObject_Dict_GetItem(__pyx_t_3, __pyx_v_tool_name); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_r = __pyx_t_1;
    __pyx_t_1 = 0;
...
*/
  {
    ...
    __pyx_t_4 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_tools_registry, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 47, __pyx_L1_error)
  }
  __pyx_t_1 = __pyx_t_4;
  __Pyx_GOTREF(__pyx_t_1);
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_registry};
    __pyx_t_5 = 0; {
      __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_1, __pyx_imported_names[__pyx_t_5]); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 47, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      switch (__pyx_t_5) {
        case 0:
        __Pyx_INCREF(__pyx_t_3);
        __pyx_v_registry = __pyx_t_3;
        break;
        default:;
      }
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = __pyx_v_registry;
  __Pyx_INCREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_v_self, __pyx_mstate_global->__pyx_n_u_default_result_size); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = 0;
  {
    PyObject *__pyx_callargs[2 + ((CYTHON_VECTORCALL) ? 1 : 0)] = {__pyx_t_3, __pyx_v_tool_name};
    __pyx_t_8 = __Pyx_MakeVectorcallBuilderKwds(1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 48, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_default, __pyx_t_6, __pyx_t_8, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 48, __pyx_L1_error)
    __pyx_t_1 = __Pyx_Object_VectorcallMethod_CallFromBuilder((PyObject*)__pyx_mstate_global->__pyx_n_u_get_max_result_size, __pyx_callargs+__pyx_t_7, (2-__pyx_t_7) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_8);
...
static int __pyx_pymod_exec_budget_config(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_budget_config},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "budget_config",
      __pyx_k_Configurable_budget_constants_fo, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_budget_config(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_budget_config(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_budget_config(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'budget_config' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "budget_config" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_budget_config", 0);
  ...
  if (__pyx_module_is_main_tools__budget_config) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "tools.budget_config")) {
      if (unlikely((PyDict_SetItemString(modules, "tools.budget_config", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_dataclasses, __pyx_imported_names, 2, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = __Pyx_PyUnicode_AsDouble(__pyx_mstate_global->__pyx_n_u_inf); if (unlikely(__PYX_CHECK_FLOAT_EXCEPTION(__pyx_t_5, ((double)((double)-1))) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_t_4 = PyFloat_FromDouble(__pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_read_file, __pyx_t_4) < (0)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_PINNED_THRESHOLDS, __pyx_t_2) < (0)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "tools/budget_config.py":18
...
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_RESULT_SIZE_CHARS, __pyx_mstate_global->__pyx_int_100000) < (0)) __PYX_ERR(0, 18, __pyx_L1_error)
 ...
 * 
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_TURN_BUDGET_CHARS, __pyx_mstate_global->__pyx_int_200000) < (0)) __PYX_ERR(0, 19, __pyx_L1_error)

  /* "tools/budget_config.py":20
 * DEFAULT_RESULT_SIZE_CHARS: int = 100_000
 * DEFAULT_TURN_BUDGET_CHARS: int = 200_000
 * DEFAULT_PREVIEW_SIZE_CHARS: int = 1_500             # <<<<<<<<<<<<<<
 * 
 * 
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_PREVIEW_SIZE_CHARS, __pyx_mstate_global->__pyx_int_1500) < (0)) __PYX_ERR(0, 20, __pyx_L1_error)

  /* "tools/budget_config.py":24
 * 
 ...
 * 
*/
  __pyx_t_2 = __Pyx_Py3MetaclassPrepare((PyObject *) NULL, __pyx_mstate_global->__pyx_empty_tuple, __pyx_mstate_global->__pyx_n_u_BudgetConfig, __pyx_mstate_global->__pyx_n_u_BudgetConfig, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_tools_budget_config, __pyx_mstate_global->__pyx_kp_u_Immutable_budget_constants_for_t); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyDict_NewPresized(4); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_default_result_size, __pyx_mstate_global->__pyx_n_u_int) < (0)) __PYX_ERR(0, 24, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_turn_budget, __pyx_mstate_global->__pyx_n_u_int) < (0)) __PYX_ERR(0, 24, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_preview_size, __pyx_mstate_global->__pyx_n_u_int) < (0)) __PYX_ERR(0, 24, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_tool_overrides, __pyx_mstate_global->__pyx_kp_u_Dict_str_int) < (0)) __PYX_ERR(0, 24, __pyx_L1_error)
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_annotations, __pyx_t_4) < (0)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "tools/budget_config.py":33
 *     """
 * 
...
*/
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_DEFAULT_RESULT_SIZE_CHARS); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_default_result_size, __pyx_t_4) < (0)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "tools/budget_config.py":34
 * 
 *     default_result_size: int = DEFAULT_RESULT_SIZE_CHARS
 *     turn_budget: int = DEFAULT_TURN_BUDGET_CHARS             # <<<<<<<<<<<<<<
 *     preview_size: int = DEFAULT_PREVIEW_SIZE_CHARS
 *     tool_overrides: Dict[str, int] = field(default_factory=dict)
*/
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_DEFAULT_TURN_BUDGET_CHARS); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_turn_budget, __pyx_t_4) < (0)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "tools/budget_config.py":35
 *     default_result_size: int = DEFAULT_RESULT_SIZE_CHARS
 *     turn_budget: int = DEFAULT_TURN_BUDGET_CHARS
 *     preview_size: int = DEFAULT_PREVIEW_SIZE_CHARS             # <<<<<<<<<<<<<<
 *     tool_overrides: Dict[str, int] = field(default_factory=dict)
 * 
*/
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_DEFAULT_PREVIEW_SIZE_CHARS); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_preview_size, __pyx_t_4) < (0)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "tools/budget_config.py":36
 *     turn_budget: int = DEFAULT_TURN_BUDGET_CHARS
 *     preview_size: int = DEFAULT_PREVIEW_SIZE_CHARS
 *     tool_overrides: Dict[str, int] = field(default_factory=dict)             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_t_6 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_7, __pyx_mstate_global->__pyx_n_u_field); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 36, __pyx_L1_error)
  ...
  __pyx_t_8 = 1;
  {
    ...
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_default_factory, ((PyObject *)(&PyDict_Type)), __pyx_t_9, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 36, __pyx_L1_error)
  ...
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_tool_overrides, __pyx_t_4) < (0)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_tool_name, __pyx_mstate_global->__pyx_n_u_str) < (0)) __PYX_ERR(0, 38, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_kp_u_int_float) < (0)) __PYX_ERR(0, 38, __pyx_L1_error)
  __pyx_t_7 = __Pyx_CyFunction_New(&__pyx_mdef_5tools_13budget_config_12BudgetConfig_1resolve_threshold, 0, __pyx_mstate_global->__pyx_n_u_BudgetConfig_resolve_threshold, NULL, __pyx_mstate_global->__pyx_n_u_tools_budget_config, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_resolve_threshold, __pyx_t_7) < (0)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;

  /* "tools/budget_config.py":23
 * 
 * 
 * @dataclass(frozen=True)             # <<<<<<<<<<<<<<
 * class BudgetConfig:
...
*/
  __pyx_t_4 = NULL;
  __pyx_t_6 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_10, __pyx_mstate_global->__pyx_n_u_dataclass); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_8 = 1;
  {
    PyObject *__pyx_callargs[2 + ((CYTHON_VECTORCALL) ? 1 : 0)] = {__pyx_t_6, NULL};
    __pyx_t_11 = __Pyx_MakeVectorcallBuilderKwds(1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_frozen, Py_True, __pyx_t_11, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 23, __pyx_L1_error)
    __pyx_t_9 = __Pyx_Object_Vectorcall_CallFromBuilder((PyObject*)__pyx_t_10, __pyx_callargs+__pyx_t_8, (1-__pyx_t_8) | (__pyx_t_8*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_11);
    __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 * 
*/
  __pyx_t_10 = __Pyx_Py3ClassCreate(((PyObject*)&PyType_Type), __pyx_mstate_global->__pyx_n_u_BudgetConfig, __pyx_mstate_global->__pyx_empty_tuple, __pyx_t_2, NULL, 0, 0); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_BudgetConfig, __pyx_t_7) < (0)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  __pyx_t_7 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_9, __pyx_mstate_global->__pyx_n_u_BudgetConfig); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_8 = 1;
  {
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_BUDGET, __pyx_t_2) < (0)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init tools.budget_config", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init tools.budget_config");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 9; } index[] = {{1},{14},{380},{179},{1},{8},{11},{22},{12},{30},{14},{26},{25},{25},{4},{17},{20},{15},{18},{18},{9},{11},{7},{15},{19},{7},{5},{6},{8},{19},{3},{3},{13},{5},{8},{13},{10},{8},{3},{11},{12},{12},{9},{8},{17},{6},{4},{12},{10},{3},{8},{9},{14},{19},{14},{11},{6},{6},{76}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (860 bytes) */
const char* const cstring = "BZh91AY&SY\334mh_\000\000L\377\376\344~\211\200L\357\274Q\277\355\377\232\277\377\377\364\200@@@@@@@@\000@@@\000@\002\375\020\344\005\0305\032I\344j\217\023Phz\215\001\352z\217P\006\200\000\320\036I\355Q\352h\006\217\02482\r\032\000\311\246!\246\203 \3040\201\2404bb4\000\00051\023DOS\312oI=OG\252\000\000\304\000\r\006@\000\000h\001)\244&@\t\2222\236\205\031\250\001\264\200\365\036\241\240\320d\007\250\320\323C\320\222\274>F\376\374\313\316\325z8Q7\212\273\246_d\005\211'C\005\003\235'\360v\373\237\2649\272\301!\226X\020\324\224H\206\317)\324\244\305\364Be\310\253\366\036s\r\274X[\225/|\254\023\207h\220\353Kr\302m.\004E\034\3513\213mRG\205\326\331\262\320=`Z\310\256\025\247\210\347\256\232jt\334\\5h\253\006\230\250$\321\366\233\260\007no\014H\210\331\242\014\351\347\014\023x!\365\336\361\002&\t\201\357P\026\030\314\374\232\354z\355\201W\217\233\257F<\006x\345\307\036L\355\335)#\205O\215\277\243N\306\262\241k\316<\016\323\240\375J6\253\212Fe\245\032;$<Wd\237\306\257Pk\023t{}\035.\377\324T!\376\246\222\370/\241A\311\301\327\252\212\240\353\251(\2501\014\\\356\301'\251\225\016h\331\344v\205\323\376 t\257\247\243\262\326<\262\373p\270\216\251lb\251GC\335\331C\253`e\333)\346\314\341\363rIG\266\272$uU\002\0035P\t\360\006\023W\020\024\314\243\210\314$\337T\221\333\010w\324\241\224\000\221\244\223\376\021 \206Lc|\351\034\r]\006b\026\251m/\271\231\245T\006*\273\245\r\227\325&\302nU\240\342\3457g\224\013\005s\321\232\226\273\033yZu;\013D\236A\213{\033}\235q\343pX\202[\214w\30665Rf\212\224\t]S\347\274A\220&-\365\333#\323\332\311\215\271\023\303*\310\030\355\271N\n\273\3520\316VV\331\225\316\014=4.L\354u;EO\217-daL\314\253g\2334\320\360i\230\020\017yq<wF\204\342\374Bw\036\024\236NY3}t5E`\203E\023\"\271\\\243&Z\217v\334m\233\034\0015\314\363\323\244N\254\003v\330\020\303#\202\331\003b\277L|\242*\271\023\275~k\270\275J\3164Z\261B\024%NH\322\353\265\007\205\357\313Y\344\337\360\326`\347\250OPaJ\342\010\321Zc\013$8\211\352J\036\326,\230\304S\252\006\000i\010Z&Qk-fz\351\253\220\354""\276\221\021\026&\356:.E\007s\036\352\212\302$\242\343\266o2E\344\243\030\n6#:\361\271\214S\265\226\225\225H9*\272\316\326S\201$\330\333\025e7Z_\007\256\317F~{\316v\370\204\327\256\0210\020\222\326\3067\330i\304\263\"\3104\016\027u\324\346[\266\243?i\3634\210\211/\030<\256;\377\177\214\240K\312\031\203\366\355x\364\212=*\332\206\037x\032\256G\035\254\277\305\334\221N\024$7\033Z\027\300";
...
const char* const cstring = "x\332mS\261n\023A\020\005\211\"\004\020E\n\332\221@J\"\310!\223\024(\005(\304\016\261\210\214\261\035\220@h5\276\233\263\027\326\273\227\335=\343CH\264\224)S\272L\231\222\222OH\231\317\340\023\230\275\263\203Q8\351\356ffgf\337\274\231\211\3522\366\037\234\267\217@j\377\2619\032\345\036\373\212\240\237'\003\362\020\033\355<j\357 5\026\374\220`sCaA,\033\243\300\222\313\225\207\214\254\223\316\223\216\t\\\301\302(Z^\006~\016J\327'\260\306\036\033\225\363\372v\2102jL\302\017Y\032\032\225\254\205dB\343\210\326a\343\031\\\332\031\023\304C\264.Z\310\266Ye\363\271\325\234\013 \010b\006\227\203q0\2604@Oe\344\274\016\214\255q\016P\251\022x\231\356\377O\205\322\205\253\021\234\324\003&\003](\217i(/\253\300\264-\215%}\331\3767:\253\254\302\311\257\024\320H\255\244fR\264\3142\206Q\2321\365\\\306\002gU\302\226a\314~\210\036v\013?4\032\244\203\204\224\354\223\345jT\001\334%nV\240~\210\032\332\215\366\306\326\323-@\2350\346O\0243f\227\367c\305`\311\201I\271t\251<\227\341\213\214\\\004\315\024\n\223\203&J\230\003\310\330o1\200{\253\3011\306\320\344U\324\332x\364\322h\301\341\314\302*$\322\362%rL!z\017\225\243\3509&\211`G\342\331\201o\220*\203>\320\353\036W\264\013\036\237T\016\242\254xQ\352\273\245\272(GWf\241\336\330\3339<\350\211\027\207\365\227\215\336\\kw\032o\233\215w\242\333|\337\020\273\373;\235\356\374\244\323\350\206\337\325\203\336a\2475\3132;`\366\332\315V\253Q\027\275}\016\333\177}P\357\n\321.&\374\206C\321\242\211\357P*\304\337\362\035+\256\320\2614Ql\254\311\231Prqh\252\220\314\215\305\230\372\030\177N\320c\311\344\245@.\241\024y\224f?\221b\354\215-\346j5g\345\240\010\221\230X\210T\222JRk\276\222f%\327l\n\034\216p\262\350,\2316\355\205t\342\022\217\344\205c\234#dD\374\214h\006\241TL\222+\nRX/!2\223\361\307R\206\226J\341r\\\2058\312QU^\2260a<\212x\225xHmq\245M\226\302*8R\314\026O\315,;K\263\3728H\010O\316\363w\276\334\245`\306d\255L\370$\014J\364\317\240T\246\371\235\013\213]\315\340\030UN\356\374\306\303\323\247g\265\337\313\327n\336\376\261}\334=\271~q{\345|\345\301tg""\372\346b\351Vi\272q\262\303\306\343\255\343\357S\234\036],\3359\277s\177Z\273X\272\373cr~\357\341i\355\364\325\331\344\247\377U\373\003Y\230\325\312";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (1279 bytes) */
const char* const bytes = ".Dict[str, int]Immutable budget constants for the 3-layer tool result persistence system.\n\n    Layer 2 (per-result): resolve_threshold(tool_name) -> threshold in chars.\n    Layer 3 (per-turn):   turn_budget -> aggregate char budget across all tool\n                          results in a single assistant turn.\n    Preview:              preview_size -> inline snippet size after persistence.\n    Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.?add_noteint | floattools/budget_config.pyBudgetConfigBudgetConfig.resolve_thresholdDEFAULT_BUDGETDEFAULT_PREVIEW_SIZE_CHARSDEFAULT_RESULT_SIZE_CHARSDEFAULT_TURN_BUDGET_CHARSDictPINNED_THRESHOLDS__Pyx_PyDict_NextRef__annotations__asyncio.coroutinescline_in_tracebackdataclassdataclassesdefaultdefault_factorydefault_result_size__doc__fieldfrozen__func__get_max_result_sizeinfint_is_coroutineitems__main____metaclass____module____name__pop__prepare__preview_size__qualname__read_fileregistryresolve_thresholdreturnself__set_name__setdefaultstr__test__tool_nametool_overridestools.budget_configtools.registryturn_budgettypingvalues\320\004+\2508\2601\360\n\000\t\014\210:\220S\230\001\330\014\023\320\023$\240A\240Q\330\010\013\210:\220S\230\004\230A\330\014\023\2204\220\177\240a\240q\330\010\r\320\r#\2401\330\010\017\210x\320\027+\2501\250K\260x\270t\3001";
    PyObject *data = NULL;
  ...
  }
  {
    ...
    int32_t const cint_constants_4[] = {100000L,200000L};
    for (int i = 0; i < 3; i++) {
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {2, 0, 0, 3, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 38};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_tool_name, __pyx_mstate->__pyx_n_u_registry};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_tools_budget_config_py, __pyx_mstate->__pyx_n_u_resolve_threshold, __pyx_mstate->__pyx_kp_b_iso88591_81_S_AQ_S_A_4_aq_1_x_1Kxt1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
