...
{
    "distutils": {
        "name": "hermes_cli.default_soul",
        "sources": [
            "hermes_cli/default_soul.py"
        ]
    },
    "module_name": "hermes_cli.default_soul"
}
END: Cython Metadata */
...
#define __PYX_HAVE__hermes_cli__default_soul
#define __PYX_HAVE_API__hermes_cli__default_soul
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "hermes_cli.default_soul" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "hermes_cli.default_soul"
extern int __pyx_module_is_main_hermes_cli__default_soul;
int __pyx_module_is_main_hermes_cli__default_soul = 0;

/* Implementation of "hermes_cli.default_soul" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Default_SOUL_md_template_seeded[] = "Default SOUL.md template seeded into HERMES_HOME on first run.";
/* #### Code section: decls ### */
...
#define __pyx_kp_u_You_are_Hermes_Agent_an_intellig __pyx_string_tab[1]
#define __pyx_n_u_DEFAULT_SOUL_MD __pyx_string_tab[2]
...
#define __pyx_n_u_qualname __pyx_string_tab[7]
#define __pyx_n_u_setdefault __pyx_string_tab[8]
#define __pyx_n_u_test __pyx_string_tab[9]
...
static int __pyx_pymod_exec_default_soul(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_default_soul},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "default_soul",
      __pyx_k_Default_SOUL_md_template_seeded, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_default_soul(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_default_soul(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_default_soul(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'default_soul' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "default_soul" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_default_soul", 0);
  ...
  if (__pyx_module_is_main_hermes_cli__default_soul) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "hermes_cli.default_soul")) {
      if (unlikely((PyDict_SetItemString(modules, "hermes_cli.default_soul", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_SOUL_MD, __pyx_mstate_global->__pyx_kp_u_You_are_Hermes_Agent_an_intellig) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)

  /* "hermes_cli/default_soul.py":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init hermes_cli.default_soul", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init hermes_cli.default_soul");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 10; } index[] = {{1},{513},{15},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (422 bytes) */
const char* const cstring = "BZh91AY&SY\020\301\234\023\000\000,_\200@\000@\005\000\000\267g\236 \277\357\377\3600\001\225\2665!\252\237\246)\212zh\323\njy&\203i4\007\244 &(\324\320\006\215\006\236P\017SCA\246\204d\251\371Q\372\210z\230\203# \003KF\224n_\221\006s\210\001H\374\022\036\003lpp6[*U!fE\310\225\263\262\371K\220v{\317\006+\217\253\027\214\021Z\243\271-\356\376\223LN\272\220\257My\246\273\007\037R^\024\364\337D\240\024\344\251\222\235\235\243B\345\321\343\341\374=\334|\317\234\243\200*\\\301\006daJ\340\265I&N2ct\214\021!\271L\001\202\004\000\200+\356\310ep7W\370oC\216\335\323s\331\2451'5\036(C\303\270$\270\223l\024\266\201B\2440\035\276\337\213e\373\214_\233\241\210\266cL\231\273\000\023*\263\335\331\341C\261