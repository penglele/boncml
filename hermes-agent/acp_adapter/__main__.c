...
{
    "distutils": {
        "name": "acp_adapter.__main__",
        "sources": [
            "acp_adapter/__main__.py"
        ]
    },
    "module_name": "acp_adapter.__main__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__acp_adapter____main__
#define __PYX_HAVE_API__acp_adapter____main__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "acp_adapter.__main__" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "acp_adapter.__main__"
extern int __pyx_module_is_main_acp_adapter____main__;
int __pyx_module_is_main_acp_adapter____main__ = 0;

/* Implementation of "acp_adapter.__main__" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Allow_running_the_ACP_adapter_as[] = "Allow running the ACP adapter as ``python -m acp_adapter``.";
/* #### Code section: decls ### */
...
#define __pyx_kp_u_acp_adapter_entry __pyx_string_tab[2]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[3]
#define __pyx_n_u_entry __pyx_string_tab[4]
#define __pyx_n_u_main __pyx_string_tab[5]
#define __pyx_n_u_main_2 __pyx_string_tab[6]
...
namespace {
  ...
  #endif
  {
      ...
      "__main__",
      __pyx_k_Allow_running_the_ACP_adapter_as, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "__main__" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit___main__", 0);
  ...
  if (__pyx_module_is_main_acp_adapter____main__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "acp_adapter.__main__")) {
      if (unlikely((PyDict_SetItemString(modules, "acp_adapter.__main__", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_main_2};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_entry, __pyx_imported_names, 1, __pyx_mstate_global->__pyx_kp_u_acp_adapter_entry, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
...
*/
  __pyx_t_4 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_main_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 5, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init acp_adapter.__main__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init acp_adapter.__main__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{17},{18},{5},{8},{4},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (80 bytes) */
const char* const cstring = "x\3325\210A\016\200 \014\004\177\304\027|\312f-5!\026D(\007\177/\301\270\207\331\311\204\215R\301\310\352\332\202\026o\217X*\212T\340\215\242;\345\\\031\310\234\361\347\025\207)\346\n\363\372{\320>\357\352Q\017\016s\300\265O\276 \240(\326";
    PyObject *data = __Pyx_DecompressString(cstring, 80, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (102 bytes) */
const char* const bytes = ".?acp_adapter.entrycline_in_tracebackentry__main__main__module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
